defmodule RhizomeTest do
  ...
  test "nix32 decode known vectors" do
    assert {:ok, bytes} = Rhizome.Nix32.decode("0f3q75ym3390abjlmrz9kx07160xyrs9b1c32zy5wsldc0vqkgwz")
  ...
  test "manifest decode + find_link" do
    ...
    assert {:ok, link} = Rhizome.Manifest.find_link(decoded.l, "test.narinfo")
    assert link.s == 42

    assert :not_found = Rhizome.Manifest.find_link(decoded.l, "missing.narinfo")
  end
end
